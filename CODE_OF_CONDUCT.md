...
This Code of Conduct applies within all community spaces (GitHub issues, pull requests, discussions, etc.) and also applies when an individual is representing the community in public spaces (e.g., social media, events).
